...
return array(
    ...
    /* -------------------------------------------------------------------------
     |
     | Misclaneous configurations
     |
     | Use to set additionnal parameters
     |
       ---------------------------------------------------------------------- */
    'misc'  => array(
        'google.analytics' => getenv('tracking.google') !== false ? getenv('tracking.google') : false
    )
);